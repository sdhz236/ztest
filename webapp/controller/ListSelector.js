sap.ui.define([
		...
		return BaseObject.extend("lscrm.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias lscrm.model.ListSelector
			 */
			 ...
			 * @return {lscrm.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
